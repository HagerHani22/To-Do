...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => TasksCubits()..creatDatabase(),),
        BlocProvider(create: (context) => MaraTasksCubits()..creatDatabase(),),
        BlocProvider(create: (context) => OETasksCubits()..creatDatabase(),),
        BlocProvider(create: (context) => ProjectCubit()..creatDatabase(),),
      ],
      child: MaterialApp(
